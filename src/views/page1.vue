    ...
    <div class="page1">
        <Row class="listTop">
            <Col span="7">
                <div class="leftTop">
                    <span class="title">
                        <span class="title-6">工程资质与专业能力匹配度</span>
                    </span>
            ...
            <Col span="7">
                <div class="rightTop-1">
                    <span class="title">
                        <span class="title-8">人员办公地图</span>
                    </span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                ...
                <div class="rightTop-2">
                    <span class="title">
                        <span class="title-6">专业技能分析</span>
                    </span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
        ...
        <Row class="listBottom">
            <Col span="9">
                <div class="content">
                    <span class="title">
                        <span class="title-6">团队项目情况</span>
                    </span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
            ...
            <Col span="4">
                <div class="content">
                    <span class="title">
                        <span class="title-6">工龄与年龄分布</span>
                    </span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                    <span class="angle4"></span>
                    <div class="behavior">
                        <pie-ring style="height: 55%" ref="chart12" :data="data7"></pie-ring>
                        <colors-bar style="height: 40%" ref="chart15" :data="colorsData"></colors-bar>
                    </div>
                </div>
            </Col>
            <Col span="4">
                <div class="content">
                    ...
                    <span class="angle4"></span>
                    <span class="title">
                        <span class="title-6">受教育情况</span>
                    </span>
                    <div class="behavior">
                        <funnel1 ref="chart12"></funnel1>
                    </div>
                </div>
            </Col>
            <Col span="7">
                <div class="content">
                    <span class="title">
                        <span class="title-6">团队成员个人画像</span>
                    </span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
...
const radarChart = () => import('./components/page1/radarChart.vue');
...
const distributionSolider = () => import('./components/page1/distributionSolider');
const funnel1 = () => import('./components/page1/funnel1');
