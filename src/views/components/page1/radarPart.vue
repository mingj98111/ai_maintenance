            ...
            <template v-else>
                    ...
                    <foreignObject class="title_1" x="102" y="364" id="title_1" width="100" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:psychologicalStatus?'#FFDBDB':''}">
                                <span class="titleText">人员画像</span>
                ...
                <g>
                    ...
                    <foreignObject class="title_1" x="76" y="232" id="title_2" width="100" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:speechStatus?'#FFDBDB':''}">
                                <span class="titleText">航线智能化</span>
                    ...
                    <foreignObject class="text" x="250" y="320" id="text_2" width="250" height="170">
                        <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <div class="promptBox">
                                <div class="promptTitle">航线智能化</div>
                                <p v-if="!showSpeech" style="text-align: center;margin-top: 40px;">
                                    {{ speech }}
                                </p>
                                <div class="psychologyContent" v-else>
                                    <div><span>{{ speech }}项目成员</span>(李宇飞，沈明京，杨乐<span>{{ speechPercent }}</span>)</div>
                ...
                <g>
                    ...
                    <foreignObject class="title_1" x="105" y="118" id="title_3" width="100" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:internetPreferenceStatus?'#FFDBDB':''}">
                                <span class="titleText">航材智慧化</span>
                    ...
                    <foreignObject class="text" x="250" y="320" id="text_3" width="250" height="170">
                        <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <div class="promptBox">
                                <div class="promptTitle">航材智慧化</div>
                                <div class="psychologyContent">
                                    <div>
                                        <span>{{ internetPreference }}项目成员</span>(梁健彬，沙治宇，杨乐<span>{{ internetPreferencePercent }}</span>)
                                    </div>
                ...
                <g>
                    <image class="bg_img" x="310" y="40"
                           :xlink:href="riskStatus?$images.sensitive_title:$images.normal_title" width="150"
                           height="50"/>
                    <foreignObject class="title_1" x="328" y="49" id="title_4" width="120" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:riskStatus?'#FFDBDB':''}">
                                <span class="titleText">TAOIX系统建设</span>
                    ...
                    <foreignObject class="text" x="250" y="320" id="text_4" width="250" height="170">
                        <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <div class="promptBox">
                                <div class="promptTitle">TAOIX系统建设</div>
                                <p v-if="!showRisk" style="text-align: center;margin-top: 40px;">
                                    {{ risk }}
                                </p>
                                <div class="psychologyContent" v-else>
                                    <div><span>{{ risk }}航线、航材、TMC、EMC、安质部、培训部、大修</span><span>{{ riskPercent }}</span></div>
                ...
                <g>
                    ...
                    <foreignObject class="title_1" x="538" y="118" id="title_5" width="120" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:entertainmentPreferenceStatus?'#FFDBDB':''}">
                                <span style="font-size: 15px;display: block;">MR培训</span>
                    ...
                    <foreignObject class="text" x="250" y="320" id="text_5" width="250" height="170">
                        <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
                            ...
                            <div class="promptBox">
                                <div class="promptTitle">MR培训</div>
                                <p v-if="!showEntertainmentPreference" style="text-align: center;margin-top: 40px;">
                                    {{ entertainmentPreference }}
                                </p>
                                <div class="psychologyContent" v-else>
                                    <div>
                                        <span>{{ entertainmentPreference }}项目成员（李宇飞）</span><span>{{ entertainmentPreferencePercent }}</span>   </div>
                ...
                <g>
                    ...
                    <foreignObject class="title_1" x="578" y="232" id="title_6" width="100" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:makeFriendStatus?'#FFDBDB':''}">
                                <span class="titleText">AR工卡</span>
                    ...
                    <foreignObject class="text" x="250" y="320" id="text_6" width="250" height="170">
                        <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <div class="promptBox">
                                <div class="promptTitle">AR工卡</div>
                                <p v-if="!showMakeFriend" style="text-align: center;margin-top: 40px;">
                                    {{ makeFriend }}
                                </p>
                                <div class="psychologyContent" v-else>
                                    <div><span>{{ makeFriend }}项目成员（巴翔）</span><span>{{ makeFriendPercent }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <g>
                    ...
                    <foreignObject class="title_1" x="555" y="364" id="title_7" width="100" height="40">
                        <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <p :style="{color:consumptionCharacteristicsStatus?'#FFDBDB':''}">
                                <span class="titleText">AI图像识别</span>
                    ...
                    <foreignObject class="text" x="250" y="320" id="text_7" width="250" height="170">
                        <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
                            <div class="promptBox">
                                <div class="promptTitle">AI图像识别</div>
                                <p v-if="!showConsumptionCharacteristics" style="text-align: center;margin-top: 40px;">
                                    {{ consumptionCharacteristics }}
                                </p>
                                <div class="psychologyContent" v-else>
                                    <div>
                                        <span>{{ consumptionCharacteristics }}项目成员（杨乐，王储，刘孟萌）</span><span>{{ consumptionCharacteristicsPercent }}</span>
                                    </div>
